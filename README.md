...
- Администратор
    + Создать, удалить, отредактировать билет.
    + Создать, удалить, отредактировать поезд.
    + Создать нового администратора
    + Просмотр действий покупателей.
    + Журналирование действий
- Клиент
    + Просмотреть, добавить в корзину, удалить из корзину билеты.
    + Просмотреть информацию о поезде билета (вагоны (их типы))
...
![image](https://user-images.githubusercontent.com/79207007/207655308-932de137-9527-4057-a516-cc43f8c7f50b.png)
