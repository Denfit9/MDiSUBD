...
![Lab1Scheme](https://user-images.githubusercontent.com/79207007/194944894-1e90d95a-26c4-423a-b169-2b5fcbbf8370.jpg)
...
|Total price          |INT(64)    | Общая стоимость товаров в корзине     |Обязательное поле                 |
...
|Price |INT(64) | Непосредственно цена билета  |Обязательное поле |
...
|IsBought |INT(1) | Статус билета, заказанные билеты можно скрывать и удалять при оформлении покупки  |Обязательное поле, только '1' или '0' |
...
|Address |VARCHAR(64) | Адрес станции  |Обязательное поле, уникальный |
